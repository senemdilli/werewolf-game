...
def main():
    ...
    parser.add_argument("--list-style", type=str, default="plain", choices=["plain", "dash"], help="Enumeration style for Static Data / Current Game State lines (default: plain)")
